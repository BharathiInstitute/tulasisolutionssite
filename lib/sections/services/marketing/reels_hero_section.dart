			...
			Row(mainAxisSize: MainAxisSize.min, children: [
				...
				Flexible(
					child: Text('Short-Form Content That Sells',
						style: GoogleFonts.openSans(color: ReelsHeroSection._headline, fontSize: isDesktop ? 40 : 28, fontWeight: FontWeight.w800, letterSpacing: 0.2)),
				),
			]),
			const SizedBox(height: 10),
			Text('Engaging reels optimized for conversions and reach.',
				style: GoogleFonts.openSans(color: ReelsHeroSection._body.withValues(alpha: 0.95), fontSize: isDesktop ? 16 : 14, height: 1.6, fontWeight: FontWeight.w500)),
